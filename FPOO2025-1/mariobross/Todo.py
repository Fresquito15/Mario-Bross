...
class Jugador:
    def __init__(self):
        ...
        print("Intentando cargar imagen:", os.path.join(ASSETS_DIR, "1.png"))
...
class Juego:
    def __init__(self):
        ...
        # Cargar imágenes
        self.imagen_fondo = pygame.image.load(ASSETS_DIR+ "7.png")
        self.imagen_jugador_pequeno = pygame.image.load(ASSETS_DIR+ "1.png").convert_alpha()
        self.imagen_jugador_grande = pygame.image.load(ASSETS_DIR+ "mario grande.png").convert_alpha()
        self.imagen_goomba_cafe = pygame.image.load(ASSETS_DIR+ "goomba cafe.png").convert_alpha()
        self.imagen_goomba_negro = pygame.image.load(ASSETS_DIR+ "goomba negro.png").convert_alpha()
        self.imagen_moneda = pygame.image.load(ASSETS_DIR+ "moneda.png").convert_alpha()
        self.imagen_hongo_crecimiento = pygame.image.load(ASSETS_DIR+ "hongo rojo.png").convert_alpha()
        self.imagen_hongo_vida = pygame.image.load(ASSETS_DIR+ "hongo verde.png").convert_alpha()
        self.imagen_estrella = pygame.image.load(ASSETS_DIR+ "6.png").convert_alpha()
